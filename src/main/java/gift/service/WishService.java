...
public class WishService {
    ...
    public Page<WishResponseDto> findWishesPaging(String email, Pageable pageable) {
        return wishRepository.findWishesByMemberEmail(email, pageable).map(WishResponseDto::from);
    }
