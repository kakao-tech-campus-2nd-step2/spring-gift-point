...
public class MemberConstants {
    ...
    public static final String INVALID_REGISTER_TYPE = "로그인 방식이 잘못되었습니다. (소셜 회원가입 -> 소셜 로그인 이용, 기존 회원가입 -> 기존 로그인 이용)";
    public static final String EMAIL_ALREADY_USED = "이미 사용 중인 이메일입니다.";
    public static final String ID_NOT_FOUND = "해당 ID를 가진 회원을 찾을 수 없습니다. id: ";
    ...
    public static final String POINT_OVERFLOW = "오버플로우가 발생했습니다.";
}
