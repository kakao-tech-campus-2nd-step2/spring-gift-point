...
public class MemberController {
    ...
    public ResponseEntity<TokenResponseDTO> register(@RequestBody MemberRequestDTO memberRequestDTO) {
        return ResponseEntity.ok(new TokenResponseDTO(memberService.register(memberRequestDTO)));
    }
    ...
    public ResponseEntity<TokenResponseDTO> login(@RequestBody MemberRequestDTO memberRequestDTO) {
        return ResponseEntity.ok(new TokenResponseDTO(memberService.login(memberRequestDTO)));
    }
}
