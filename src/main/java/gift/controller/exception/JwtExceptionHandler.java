...
public class JwtExceptionHandler {
    ...
    @ApiResponse(responseCode = "401_1", description = "토큰 변조 또는 잘못된 키")
    ...
    @ApiResponse(responseCode = "401_2", description = "토큰 만료")
    ...
    @ApiResponse(responseCode = "401_3", description = "지원하지 않는 Jwt형식")
    ...
    @ApiResponse(responseCode = "400_3", description = "Jwt 구조 오류")
