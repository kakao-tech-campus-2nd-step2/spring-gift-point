...
public class ProductOptionController {
    ...
    public ResponseEntity<ProductOptionResponseDto> addProductOption(
            ...
            @Parameter(description = "추가할 상품 옵션의 정보", required = true) @RequestBody ProductOptionRequestDto productOptionRequestDto) {
    ...
    public ResponseEntity<ProductOptionResponseDto> updateProductOption(
            @Parameter(description = "수정할 상품 ID", required = true) @PathVariable Long productId,
            @Parameter(description = "수정할 옵션 ID", required = true) @PathVariable Long optionId,
            @Parameter(description = "수정할 상품 옵션의 정보", required = true) @RequestBody ProductOptionRequestDto productOptionRequestDto) {
    ...
    public ResponseEntity<Void> deleteProductOption(
            ...
            @Parameter(description = "삭제할 옵션 ID", required = true) @PathVariable Long optionId) {
