...
public class WishController {
    ...
    public WishController(WishService wishService, TokenController tokenController) {
    ...
    public ResponseEntity<Void> delete(@PathVariable("wishId") Long wishId) throws IllegalAccessException {
