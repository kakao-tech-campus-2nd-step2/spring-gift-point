...
public class WishController {
    ...
    public ResponseEntity<String> removeWish(@PathVariable Long productId, @LoginMember Member member) {
        if (member == null) {
        ...
        try {
            ...
            return ResponseEntity.badRequest().body("찜 목록에서 제거 실패: " + e.getMessage());
        }
