...
public class UserController {
    ...
    public ResponseEntity<UserResponseDto> registerUser(
            @Parameter(description = "등록할 사용자의 정보", required = true) @RequestBody UserRegisterDto userRegisterDTO) {
    ...
    public ResponseEntity<String> loginUser(
            @Parameter(description = "로그인할 사용자의 정보", required = true) @RequestBody UserLoginDto userLoginDTO) {
    ...
    public ResponseEntity<UserResponseDto> updateUser(
            ...
            @Parameter(description = "수정할 사용자의 정보", required = true) @RequestBody UserRegisterDto userRegisterDTO) {
