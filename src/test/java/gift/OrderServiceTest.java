...
//        when(optionService.getOptionById(any(Long.class))).thenReturn(option);
...
//        verify(optionService, times(1)).getOptionById(any(Long.class));
...
//        when(memberRepository.findById(any(Long.class))).thenReturn(Optional.of(member));
//        when(productService.getProductById(any(Long.class))).thenReturn(product);
//        when(optionService.getOptionById(any(Long.class))).thenReturn(otherOption);
//
//        Exception exception = assertThrows(Exception.class, () -> {
//            orderService.placeOrder(orderRequest, 1L);
//        });
