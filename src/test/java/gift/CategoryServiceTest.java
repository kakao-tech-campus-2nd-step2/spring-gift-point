...
public class CategoryServiceTest {
    ...
    @Test
    void addCategory(){
        CategoryDTO expect = new CategoryDTO(null, "testCategory1", "testColor1", "testUrl1",
            "testDescription1", new ArrayList<>());
        ...
        assertAll(
            () -> assertThat(actual.getId()).isEqualTo((long)categoryService.getAllCategory().size()),
    ...
    void updateCategory(){
        ...
        CategoryDTO expect = new CategoryDTO(1L, "testCategory2", "testColor2", "testUrl2",
