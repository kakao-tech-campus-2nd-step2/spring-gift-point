...
public class WishListRepositoryTest {
    ...
    void saveWishLists() {
        ...
        assertAll(
            () -> assertThat(
                wishlists.findAllByMemberId(memberA.getId(), pageable)
                    .stream()
                    .toList()
                    .size())
                .isEqualTo(1),
            () -> assertThat(
                wishlists.findAllByMemberId(memberB.getId(), pageable)
                    .stream()
                    .toList()
                    .size())
                .isEqualTo(2)
    ...
    @Test
    void update() {
        var wishlist = new WishList(memberA, productA);
        ...
        update.setProduct(productB);

        assertThat(update.getProduct().getId()).isEqualTo(2L);
    }
