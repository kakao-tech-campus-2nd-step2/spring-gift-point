...
public class ProductTest {
    ...
    public void setUp() {
        ...
        productResponse = new ProductResponse(1L, "아이스 아메리카노 T", 4500, "https://example.com/image.jpg", 1L);
    ...
    public void testGetProducts() {
        ...
        when(productService.getProducts(1L, pageable)).thenReturn(productPage);

        ResponseEntity<Page<ProductResponse>> response = productController.getProducts(1L, pageable);
