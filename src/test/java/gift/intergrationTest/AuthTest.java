...
public class AuthTest {
    ...
    String initForToken() {
        restTemplate.postForObject(requestUrlPrefix + port + "/api/members/register", testUser, Long.class);
        ResponseEntity<String> result = restTemplate.postForEntity(
            requestUrlPrefix + port + "/api/members/login", testUser, String.class);
    ...
    void testAuthRequestSuccess() {
        ...
        RequestEntity<?> request = new RequestEntity<>(headers, HttpMethod.GET,
            URI.create(requestUrlPrefix + port + "/api/wishes"));
