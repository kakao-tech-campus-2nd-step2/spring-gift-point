...
class OptionCRUDTest {
    ...
    void 옵션_create_테스트() {
        // Given
        Product product = productRepository.findAllByCategoryId(1L).get(0);
        Option option = new Option("아메리칸 정통 스타일", 10L, product);
        ...
        assertThat(savedOption.getQuantity()).isEqualTo(10L);
        assertThat(savedOption.getProduct()).extracting("id").isEqualTo(product.getId());
    }
